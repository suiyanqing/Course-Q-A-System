<%@ page language="java" import="dao.*" pageEncoding="UTF-8" %>
 ...
 <%@page import="util.*" %>
 <%  %>
 <% Map map = Query.make("jiedapingfen").where("id", request.getParameter("id")).find(); %>
                    ...
                    <table class="new-detail">
                        <tbody>
                            <tr>
                                ...
                                <td class="detail-value"><% Map mapkechengfenlei25 = new CommDAO().find("SELECT fenleimingcheng,id FROM kechengfenlei where id='" + map.get("fenlei") + "'"); %>
<%= mapkechengfenlei25.get("fenleimingcheng") %></td>
                            </tr>
                            <tr>
                                <td class="detail-title">提问人</td>
                                <td class="detail-value"><%= map.get("tiwenren") %></td>
                                <td class="detail-title">问题解答</td>
                            ...
                            <tr>
                                ...
                                <td class="detail-value"><%= map.get("pingfen") %></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
