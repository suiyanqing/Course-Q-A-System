...
<div>
        ...
        <div class="panel-body">
            <div class="form-search pa10 bg-warning">
                <form class="form-inline" action="?" size="small" id="formSearch">
                    ...
                    分类：
                    <select class="form-control class_fenlei24" data-value="<%= request.getParameter("fenlei") !=null ? request.getParameter("fenlei") : "" %>" id="fenlei" name="fenlei">
 ...
 <% for (Map m : select) { %>
                    ...
                    <script>
                        $(".class_fenlei24").val($(".class_fenlei24").attr("data-value"));
                    </script>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td><% Map mapkechengfenlei24 = new CommDAO().find("SELECT fenleimingcheng,id FROM kechengfenlei where id='" + map.get("fenlei") + "'"); %>
<%= mapkechengfenlei24.get("fenleimingcheng") %></td>
