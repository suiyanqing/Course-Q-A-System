...
<div>
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="kechengfenlei.jsp?a=insert" method="post" name="form1" id="form1">
                <!-- form 标签开始 -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input
                                ...
                                remote="factory/checkno.jsp?checktype=insert&table=kechengfenlei&col=fenleimingcheng"
