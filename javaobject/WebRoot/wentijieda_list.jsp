...
<div>
        ...
        <div class="panel-body">
            <div class="form-search pa10 bg-warning">
                <form class="form-inline" action="?" size="small" id="formSearch">
                    ...
                    分类：
                    <select class="form-control class_fenlei19" data-value="<%= request.getParameter("fenlei") !=null ? request.getParameter("fenlei") : "" %>" id="fenlei" name="fenlei">
 ...
 <% for (Map m : select) { %>
                    ...
                    <script>
                        $(".class_fenlei19").val($(".class_fenlei19").attr("data-value"));
                    </script>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td><% Map mapkechengfenlei10 = new CommDAO().find("SELECT fenleimingcheng,id FROM kechengfenlei where id='" + map.get("fenlei") + "'"); %>
<%= mapkechengfenlei10.get("fenleimingcheng") %></td>
                            ...
                            <td align="center">
                                ...
                                <a class="btn btn-danger btn-xs" href="wentijieda.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定删除？此操作不可恢复')" title="删除">
                                    删除
                                </a>
