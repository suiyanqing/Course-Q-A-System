...
<div>
 ...
 <% for (Map m : select) { %>
                    ...
                    <script>
                        $(".class_fenlei20").val($(".class_fenlei20").attr("data-value"));
                    </script>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td><% Map mapkechengfenlei12 = new CommDAO().find("SELECT fenleimingcheng,id FROM kechengfenlei where id='" + map.get("fenlei") + "'"); %>
<%= mapkechengfenlei12.get("fenleimingcheng") %></td>
                            ...
                            <td align="center">
                                <% if ( Query.make("jiedapingfen").where("wentijiedaid" , map.get("id")).count() == 0 ) {%>
                                <a class="btn btn-primary btn-xs" href="jiedapingfen_add.jsp?id=<%= map.get("id") %>"> 解答评分 </a>
                                <% } %>
