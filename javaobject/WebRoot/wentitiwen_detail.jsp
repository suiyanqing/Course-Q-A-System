                    ...
                    <table class="new-detail">
                        <tbody>
                            <tr>
                                ...
                                <td class="detail-value"><% Map mapkechengfenlei7 = new CommDAO().find("SELECT fenleimingcheng,id FROM kechengfenlei where id='" + map.get("fenlei") + "'"); %>
<%= mapkechengfenlei7.get("fenleimingcheng") %></td>
                            </tr>
                            <tr>
                                <td class="detail-title">封面</td>
                                <td class="detail-value">
                                    <img src="<%= map.get("fengmian") %>" style="width: 350px" />
                                </td>
                ...
                <div class="mt10 pa10 bg-white">
                    <div class="new-detail-line">
                        ...
                        <td class="detail-value"><%= map.get("neirong") %></td>
                    </div>
                </div>
