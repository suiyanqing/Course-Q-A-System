...
<%
    ...
    List<HashMap> list = Query.make("yonghu").field("yonghuming ,xingming , SUM(pingjiafen) pingjiafen ,SUM(youxiufen) youxiufen, SUM(jiedashu) jiedashu,SUM(tiwenshu) tiwenshu")
            .where(where)
