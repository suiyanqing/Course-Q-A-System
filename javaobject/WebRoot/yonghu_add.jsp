            ...
            <form action="yonghu.jsp?a=insert" method="post" name="form1" id="form1">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control class_cx3" data-value="" data-rule-required="true" data-msg-required="请填写权限" id="cx" name="cx" style="width: 250px">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input type="hidden" name="dayidengji" id="dayidengji" value="暂无" />
                            <input type="hidden" name="tiwendengji" id="tiwendengji" value="暂无" />
