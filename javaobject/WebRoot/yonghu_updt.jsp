            ...
            <form action="yonghu.jsp?a=update" method="post" name="form1" id="form1">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <script>
                                $(".class_cx9").val($(".class_cx9").attr("data-value"));
                            </script>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control class_dayidengji11" data-value="<%= Info.html(mmm.get("dayidengji")) %>" id="dayidengji" name="dayidengji" style="width: 250px">
                                <option value="暂无">暂无</option>
                                <option value="一般">一般</option>
                                <option value="优秀">优秀</option>
                            </select>
                            <script>
                                $(".class_dayidengji11").val($(".class_dayidengji11").attr("data-value"));
                            </script>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control class_tiwendengji12" data-value="<%= Info.html(mmm.get("tiwendengji")) %>" id="tiwendengji" name="tiwendengji" style="width: 250px">
                                <option value="暂无">暂无</option>
                                <option value="一般">一般</option>
                                <option value="优秀">优秀</option>
                            </select>
                            <script>
                                $(".class_tiwendengji12").val($(".class_tiwendengji12").attr("data-value"));
                            </script>
                        </div>
                    </div>
                </div>
