            ...
            <form action="youxiudafen.jsp?a=insert" method="post" name="form1" id="form1">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10"><%
                        Map mapkechengfenlei35 = new CommDAO()
                            .find("SELECT fenleimingcheng,id FROM kechengfenlei where id='" + readMap.get("fenlei") + "'");
                        %>
<%= mapkechengfenlei35.get("fenleimingcheng") %><input type="hidden" id="fenlei" name="fenlei" value="<%= Info.html(readMap.get("fenlei")) %>" /></div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <select
                                class="form-control class_youxiupingfen31"
                                data-value=""
