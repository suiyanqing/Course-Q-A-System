...
where += " AND pingjialaoshi='" + session.getAttribute("username") + "' "; //  设置pingjialaoshi为当前登录用户
...
<div>
        ...
        <div class="panel-body">
            <div class="form-search pa10 bg-warning">
                <form class="form-inline" action="?" size="small" id="formSearch">
                    ...
                    分类：
                    <select class="form-control class_fenlei29" data-value="<%= request.getParameter("fenlei") !=null ? request.getParameter("fenlei") : "" %>" id="fenlei" name="fenlei">
 ...
 <% for (Map m : select) { %>
                    ...
                    <script>
                        $(".class_fenlei29").val($(".class_fenlei29").attr("data-value"));
                    </script>

                    优秀评分：
                    <select
                        class="form-control class_youxiupingfen30"
                    ...
                    <script>
                        $(".class_youxiupingfen30").val($(".class_youxiupingfen30").attr("data-value"));
                    </script>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td><% Map mapkechengfenlei33 = new CommDAO().find("SELECT fenleimingcheng,id FROM kechengfenlei where id='" + map.get("fenlei") + "'"); %>
<%= mapkechengfenlei33.get("fenleimingcheng") %></td>
