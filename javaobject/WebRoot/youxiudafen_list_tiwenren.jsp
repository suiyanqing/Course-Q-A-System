...
<div>
 ...
 <% for (Map m : select) { %>
                    ...
                    <script>
                        $(".class_fenlei27").val($(".class_fenlei27").attr("data-value"));
                    </script>

                    优秀评分：
                    <select
                        class="form-control class_youxiupingfen28"
                    ...
                    <script>
                        $(".class_youxiupingfen28").val($(".class_youxiupingfen28").attr("data-value"));
                    </script>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td><% Map mapkechengfenlei31 = new CommDAO().find("SELECT fenleimingcheng,id FROM kechengfenlei where id='" + map.get("fenlei") + "'"); %>
<%= mapkechengfenlei31.get("fenleimingcheng") %></td>
